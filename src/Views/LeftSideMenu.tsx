import { HStack, VStack, Text, UIImage, Teact, DynamicView, cTop, RoundedRectangle, Color, HDivider, PositionTypes, Spacer, cTopLeading, OverlayPanel, UIContextMenu, ForEach, bindState } from "@tuval/forms"
...
export const LeftSidemenu = (menu: any[]) => {
    const [selectedMenuItem, setSelectedMenuItem] = bindState('Home');
    return (
        ...
        ).maxWidth('66px').minWidth('66px').background('#333').paddingTop('10px').zIndex(2)
    )
}
